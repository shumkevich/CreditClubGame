const questData = {
    // ================== БЛОК 1: ПРИВЕТСТВИЕ ==================
    "start": {
        "text": "Привет, [PLAYER_NAME]!\n Меня зовут Мария, я менеджер по сопровождению клиентов.\nСегодня я покажу тебе как проходят наши сделки\n\nГотов к своей первой встрече?",
    ...
    "block2_intro": {
        "text": "Отлично. \nВсю информацию о новых клиетах (ФИО, Адрес), мы будем высылать в чате Телеграм.\n Он будет выглядить так Credit.Club Город (Твоя Фамилия).\nНапример так выглядит моё шаблонное сообщение:.",
        "imageUrl": "images/start.jpg",
        "next_scene": "block2_deal_info"
    },
    "block2_deal_info": {
        "text": "У нас во вторник (или любой удобный день для клиента) планируется сделка.\nДиапазон времени 09.00-14.00 по МСК\nФИО = Козак Тимофей Анатольевич\nтел = +7 911 454-97-20\nадрес = г Калининград, ул В.Фермора , д 10 , кв 153\nНужно созвониться в ближайшее время с клиентом (ждет звонка) и написать в чат.\"",
        "imageUrl": "images/start1.jpg",
        "next_scene": "block2_call_prompt"
    },
    "block2_call_prompt": {
        "text": "Клиент ждет вашего звонка прямо сейчас! \nПредставьтесь, расскажите, что будет происходить на сделке. \nГлавное нужна конкретная дата и время, когда вы сможете вместе встретиться на объекте и начать сделку. \nОбязательно после разговора написать в чат, на какую дату/время вы договорились.",
    ...
    "block3_call_question": {
        "text": "Тимофей Анатольевич, здравствуйте! \nМеня зовут [PLAYER_NAME], у нас с вами назначена сделка. \nХотел бы договориться о дате и времени.",
    ...
    "block3_success": { "text": "[Тимофей Анатольевич]: Да конечно, удобно. Жду вас у себя [PLAYER_NAME]", "imageUrl": "images/call.jpg", "next_scene": "block3_end_call" },
    ...
    "block4_question": {
        ...
        "choices": [
            ...
            { "text": "Буду ждать звонка менеджера", "next_scene": "block4_fail" },
            { "text": "Выезжаю к клиенту", "next_scene": "block4_fail" }
        ]
    },
    ...
    "block4_success": { "text": "[Мария]: Спасибо. Готовим документы. Напишем вам в чате по готовности", "imageUrl": "images/docs3.jpg", "next_scene": "block4_info" },
    "block4_info": { "text": "[Мария]: \"Документы для сделки готовы, можно печатать. Документа всего два для печати - Заявление-анкета (1 экз) и Заявление на КЭП (2 экз). Также в приложении вы найдете чек-лист для видеозаписи подписания. \nКак будете выезжать к клиенту - просьба ему написать или позвонить, сообщить что выехали и ориентировочное время прибытия\"", "imageUrl": "images/docs4.jpg", "choices": [{ "text": "Конечно!", "next_scene": "block5_intro" }] },

    // ================== БЛОК 5: ПЕЧАТЬ ДОКУМЕНТОВ ==================
    "block5_intro": { "text": "(спустя некоторое время) \n\n[Мария]: \"Документы для сделки в вашем приложении. Чтобы получить документы для сделки, откройте приложение Credit.Club Agent → выберите заявку → в разделе 'Документы' нажмите 'Отправить себе на почту'\"", "imageUrl": "images/print.jpg", "next_scene": "block5_check" },
    "block5_check": { "text": "[Мария]: \"Распечатали? \nПроверили ли все документы по чек листу?\"", "imageUrl": "images/print.jpg", "choices": [{ "text": "Да!", "next_scene": "block6_question" }] },
    ...
    "block6_question": {
        ...
        "choices": [
            ...
            { "text": "проверить комплектность документов и возможные ошибки", "correct": true },
            { "text": "позвонить клиенту и подтвердить встречу за сутки", "correct": true },
    ...
    "block7_intro": {
        "text": "В ДЕНЬ ВСТРЕЧИ \n\n[Мария]: \"Как будете на месте, первым делом ждем фотографии объекта. Загружайте в приложение агента (Шаг 1). И сообщите нам в чат, чтобы мы проверили\"",
    ...
    "block7_on_site": { "text": "[PLAYER_NAME]: Хорошо, я на месте. Начинаю фотографировать объект.", "imageUrl": "images/photohouse1.jpg", "next_scene": "block7_checklist1" },
    "block7_checklist1": {
    ...
    "block8_intro": { "text": "[Мария]: \"Отлично, ожидаем проверки объекта нашими юристами. \n\nПока можно фотографировать все документы клиента. Паспорт (все страницы), селфи с паспортом, снилс, документы по объекту. \nЗагрузите фотографии в приложение (Шаг 2).\"", "imageUrl": "images/photodocs.jpg", "choices": [{ "text": "Фото документов загрузил в Шаг 2", "next_scene": "block8_assessment_prompt" }] },
    ...
    "block8_assessment_choice": {
        "text": "Признаки неблагонадёжного клиента:\nНеопрятный вид, запах алкоголя, дрожащие руки, путается в ответах, торопится подписать, не может объяснить цель займа, посторонние люди на сделке и т.д.",
        "imageUrl": "images/photodocs.jpg",
        "choices": [
            { "text": "Клиент ок. Объект удовлетворительно", "next_scene": "block8_success" }
        ]
    },
    ...
    // ================== БЛОК 9: ВЫПУСК КЭП ==================
    "block9_intro": { "text": "^Пример документа^\n\n[Мария]: \"Теперь подпишите, пожалуйста, с клиентом заявление на выпуск КЭП \n и пришлите нам 2 фотографии в приложение (шаг 3). \nДолжно получится: \n1.Фото подписанного документа КЭП \n2.Селфи клиента с КЭП\"", "imageUrl": "images/sign.jpg", "next_scene": "block9_info1" },
    "block9_info1": { "text": "Клиент ставит 3 подписи в документе. Вы делаете фото клиента с первой страницей заявления и фото документа. После чего отправляете в приложение.", "imageUrl": "images/sign2.png", "choices": [{ "text": "Загрузил в Шаг 3", "next_scene": "block9_signme_prompt" }] },
    "block9_signme_prompt": { "text": "^ИНСТРУКЦИЯ^\n\n[Мария]: \"Теперь перейдите к выпуску КЭП в приложении SignMe, вход через сканирование QR-кода на заявлении. Главное, чтобы клиент указал свой номер +7 911 454-97-20. Как дойдете до шага 'Ожидание подтверждения личности', сообщите в чат\"", "imageUrl": "images/sign3.jpg", "next_scene": "block9_signme_info" },
    "block9_signme_info": { "text": "^ИНСТРУКЦИЯ^\n\nКлиент открывает приложение SignMe, сканирует QR-код, устанавливает пин-код. Появляется экран ожидания подтверждения личности.", "imageUrl": "images/sign4.jpg", "choices": [{ "text": "[Сообщение]: Ожидаем подтверждения личности", "next_scene": "block9_continue_kep" }] },
    "block9_continue_kep": { "text": "[Мария]: \"^ИНСТРУКЦИЯ^\n\nМожно продолжать выпуск КЭП. Напишите, как закончите\"", "imageUrl": "images/sign5.jpg", "next_scene": "block9_finish_kep" },
    ...
    "block10_intro": { "text": "[Мария]: \"^Пример документа^\n\nТеперь можете подписать с клиентом анкету-заявление и загрузить в шаг 3\"\n\nОбратите внимание, что здесь необходимо заполнить:\n- «ФИО клиента» (полностью)\n- «Наличие ограничений/обременений»\n- галочку в графе «Согласен» и подпись клиента\n- Вашу ФИО полностью и ниже Фамилия - Инициалы - подпись. \n [PLAYER_NAME], проверили?.", "imageUrl": "images/signdocs.jpg", "choices": [{ "text": "Подписано и отправлено в Шаг 3", "next_scene": "block11_intro" }] },
    ...
    "block12_intro": { "text": "[Мария]: \"Формируем документы на подпись. Подписание проводится под видеозапись. \n Мы направляли вам чеклист видеозаписи, его можно найти со всеми документами.\n На видео необходимо произнести номер договора, дату, стороны, сумму. Можно читать прямо с листка. Документы появятся в личном кабинете через 10 минут.\"", "imageUrl": "images/electronicsign.jpg", "choices": [{ "text": "Ожидаем", "next_scene": "block12_sign_prompt" }] },
    "block12_sign_prompt": { "text": "[Мария]: \"Клиент может подписывать документы в личном кабинете под видеозапись. Для этого нужно зайти в приложение Credit.Club Деньги → Документы → Подписать. Затем открыть приложение Sign.Me. \nА вы в это время готовите камеру и уже начинаете запись.\"", "imageUrl": "images/electronicsign.jpg", "next_scene": "block12_signme_info" },
    ...
    "block12_checklist_prompt": { "text": "В видео должно быть четко видно лицо клиента! Используйте ваш чек-лист с текстом. Начните видеосъемку, скажите клиенту, что начали процес подписания документов под видеозапись. Не торопитесь, проговаривайте все точно и четко.", "imageUrl": "images/electronicsign.jpg", "choices": [{ "text": "Далее к чек-листу", "next_scene": "block12_checklist" }] },
    "block12_checklist": { "text": "Чек-лист видеозаписи:\nСегодня [Дата]\nПодписываются: договор займа, залога, график платежей...\nСтороны: КПК \"Фонд Ипотечного Кредитования\" и [ФИО Клиента]\nПодписание происходит посредством КЭП.\nСумма займа — [Сумма]\n[ФИО Клиента], если изучили условия и нет вопросов, можно подписывать. \n\nПродолжайте снимать как клиент подписывает документы электронно.\nПосле того как подписание будет завершено - говорим об этом вслух и заканчиваем съемку. \nВидео направляем сразу в чат", "imageUrl": "images/electronicsign.jpg", "choices": [{ "text": "Отправить готовое видео в чат", "next_scene": "block13_intro" }] },

    // ================== БЛОК 13: ПОДПИСЬ ДЛЯ РОСРЕЕСТРА ==================
    "block13_intro": { "text": "Ожидайте. требуется некоторе время для проверки. \n\n[Мария]: \"Готовим заявление на подпись в Росреестр. Сообщу как можно будет подписывать\"\n\n(проходит пара минут)", "imageUrl": "images/lastsign.jpg", "choices": [{ "text": "Ожидаем", "next_scene": "block13_sign_prompt" }] },
    "block13_sign_prompt": { "text": "[Мария]: \"Теперь клиент может подписывать заявление в Росреестр в SignMe. \nАлгоритм такой же (без видео)\"", "imageUrl": "images/lastsign.jpg", "choices": [{ "text": "Клиент подписал", "next_scene": "block13_end_deal" }] },
