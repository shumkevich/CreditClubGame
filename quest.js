const questData = {
    ...
    // ================== БЛОК 15: ЗАВЕРШЕНИЕ ==================
      "block15_final": {
        ...
        // ДОБАВЛЯЕМ НОВЫЙ БЛОК CHOICES
        "choices": [
            { 
                "text": "Написать Никите в Телеграм", 
                "link": "https://t.me/Shumkov_cc?text=Добрый%20день%20Никита%2C%20я%20прошел%20свою%20первую%20тестовую%20сделку." 
            }
        ]
    }

}
// Убедитесь, что после фигурной скобки } стоит запятая, если дальше идут другие сцены. Если это последняя, запятая не нужна.
